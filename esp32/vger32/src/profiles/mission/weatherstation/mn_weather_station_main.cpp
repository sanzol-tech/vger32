/*
 * mn_weather_station_main.cpp
 *
 * Setup and loop for the weather station mission.
...
#include "mn_weather_station_main.h"
...
void mn_weather_station_setup() {
    ...
    cmd_dispatcher_init(mn_weather_station_on_cmd);
    mn_weather_station_init();
}

void mn_weather_station_loop() {
    sensor_reader_update();
    mn_weather_station_update();
    digital_out_update();
    rgb_out_update();
}
